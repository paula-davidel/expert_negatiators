<?php
/**
 * Expert Negotiators: Color Patterns
 *
 * @package WordPress
 ...
 */
function expertnegotiators_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Expert Negotiators default saturation level.
	 *
	 * @since Expert Negotiators 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'expertnegotiators_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.expertnegotiators-front-page) .entry-title,
...
.colors-custom .expertnegotiators-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.expertnegotiators-front-page .panel-content .recent-posts article,
...
.colors-custom.expertnegotiators-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Expert Negotiators custom colors CSS.
	 *
	 * @since Expert Negotiators 1.0
	 *
	 ...
	 */
	return apply_filters( 'expertnegotiators_custom_colors_css', $css, $hue, $saturation );
}
