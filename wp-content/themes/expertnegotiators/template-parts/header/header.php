  ...
  <body>
    <nav>
      <div class="nav-grid">
        ...
        <a class="link1 mobile-hide" href="<?php echo get_site_url();?>/acasa">Acasa</a>
        <a class="link2 mobile-hide" href="<?php echo get_site_url();?>/despre-noi">Despre Noi</a>
        <a class="link3 mobile-hide" href="<?php echo get_site_url();?>/servicii">Servicii</a>
        <a class="link4 mobile-hide" href="<?php echo get_site_url();?>/blog">Blog </a>
        <a class="link5 mobile-hide" href="<?php echo get_site_url();?>/contact">Contact</a>
